...
const MOCK_CROPS = [
  ...
  { id: '2', name: 'Rice', description: 'High water requirement, monsoon crop.', imageUrl: 'https://images.unsplash.com/photo-1512480175961-f0b38e9da546?q=80&w=400&h=300&auto=format&fit=crop' },
