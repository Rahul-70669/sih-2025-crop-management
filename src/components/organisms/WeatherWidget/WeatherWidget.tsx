      ...
      <div className="relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-around gap-8">
          ...
          <div className="grid grid-cols-2 gap-6 bg-white/5 backdrop-blur-sm p-6 rounded-3xl border border-white/10">
            <div className="text-center">
              <span className="material-symbols-outlined text-blue-200 block mb-1">humidity_percentage</span>
            ...
            <div className="text-center">
              <span className="material-symbols-outlined text-blue-200 block mb-1">air</span>
